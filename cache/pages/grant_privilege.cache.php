...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 5931,
      'name' => 'Moderator',
      'path' => 'packages/user/modules/Moderator/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 338,
  ...
  'title_1' => 'Quản lý quyền của tài khoản',
  'cachable' => 0,
  'params' => '',
  'hide' => 0,
  'theme' => 'web',
  'title' => 'Quản lý quyền của tài khoản',
);
...
<?php } ?>
<?php $blocks[72965]['object']->on_draw();?>
<?php $blocks[71565]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
