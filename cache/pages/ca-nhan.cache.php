...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 6262,
      'name' => 'Router',
      'path' => 'packages/frontend/modules/Router/',
      'type' => '',
...
<?php } ?><div class="container">
	<header>
		<div class="header">
<?php $blocks[78697]['object']->on_draw();?></div>
		<span class="glyphicon glyphicon-th" id="openPanel"></span>
	</header>
	<div class="content clearfix">		
		<div id='panel'>
			
<?php $blocks[78700]['object']->on_draw();?>
		</div>
		<div class="panelOut">
<?php $blocks[78698]['object']->on_draw();?></div>
		
	</div>
	<footer id="footer">
		<div class="footer">
<?php $blocks[78699]['object']->on_draw();?></div></div>
	</footer>
</div>
<script>
	jQuery(function(){
