...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 6209,
      'name' => 'Dashboard',
      'path' => 'packages/backend/modules/Dashboard/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 332,
...
<?php } ?>
<?php $blocks[77955]['object']->on_draw();?>
<?php $blocks[77962]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
