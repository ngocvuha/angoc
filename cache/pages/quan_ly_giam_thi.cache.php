...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 6258,
      'name' => 'QuanLyGiamThi',
      'path' => 'packages/exam/modules/QuanLyGiamThi/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 344,
  ...
  'name' => 'quan_ly_giam_thi',
  'title_1' => 'Danh sách giám thị',
  'cachable' => 0,
  'params' => '',
  'hide' => 0,
  'theme' => 'web',
...
<?php } ?>
<?php $blocks[78651]['object']->on_draw();?>
<?php $blocks[78653]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
