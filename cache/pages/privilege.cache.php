...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 5930,
      'name' => 'Privilege',
      'path' => 'packages/user/modules/Privilege/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 338,
...
<?php } ?>
<?php $blocks[76036]['object']->on_draw();?>
<?php $blocks[71562]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
