...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 6288,
      'name' => 'DSPhongThi',
      'path' => 'packages/exam/modules/DSPhongThi/',
      'type' => NULL,
...
<?php } ?>
<?php $blocks[79713]['object']->on_draw();?>
<?php $blocks[79715]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
