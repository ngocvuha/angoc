...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 5917,
      'name' => 'UserAdmin',
      'path' => 'packages/user/modules/UserAdmin/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 338,
...
<?php } ?>
<?php $blocks[71504]['object']->on_draw();?>
<?php $blocks[71506]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
