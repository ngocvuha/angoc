<div class="middle">
	<div class="content-header clrfix">
    	<div class="fl title">
        	Danh sách Phòng Thi<?php echo ' <span>[ '.Portal::get_action(Url::get('cmd')).' ]</span>';?>
        </div>
    </div>
	<div class="form-content">
        ...
        <table width="100%" cellpadding="2" cellspacing="0" border="1" style="border-collapse:collapse" bordercolor="#CCCCCC">
            ...
            <tr valign="middle" <?php Draw::hover('#E2F1DF');?> style="<?php if($index++%2){echo 'background-color:#F9F9F9';}?>" id="BangDiem_tr_<?php echo $this->map['items']['current']['id'];?>">
                <td>
                    <label for="BangDiem_checkbox_<?php echo $this->map['items']['current']['id'];?>"><?php echo $this->map['items']['current']['Ten'];?></label>
                </td>                
                ...
                <td align="center"><a href="<?php echo Url::build_current(array('id'=>$this->map['items']['current']['id'],'cmd'=>'view'));?>"><img src="<?php echo 'templates/admin/images/buttons/edit.jpg';?>"></a></td>
            </tr>
