...
jQuery(function() {
	var index = {{$i}};
    var row = '<tr>';
	row += '<td><input name="user[index][id]" type="hidden" /><input name="user[index][HoTen]" /></td>';
	row += '<td><input name="user[index][Khoa]" /></td>';
	row += '<td><input name="user[index][IDUser]" /></td>';
	row += '<td><input name="user[index][Password]" type="password" /></td>';
	row += '</tr>';
