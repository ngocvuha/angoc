<?php
class ListBangDiemForm extends Form
{
	function ListBangDiemForm()
	{
		Form::Form('ListBangDiemForm');
	}
	function on_submit(){
	...
	function draw()
	{
		...
		$this->map['total'] = BangDiemDB::get_total_item($cond);
		...
		$this->map['items'] = BangDiemDB::get_items($cond,String::order_by_sql($order_field,$order_default),$item_per_page);
