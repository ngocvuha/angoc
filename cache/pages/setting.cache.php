...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 5923,
      'name' => 'Setting',
      'path' => 'packages/backend/modules/Setting/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 332,
  ...
  'name' => 'setting',
  'title_1' => 'Quản lý cấu hình website',
  'cachable' => 0,
  'params' => '',
  'hide' => 0,
  'theme' => 'web',
  'title' => 'Quản lý cấu hình website',
);
...
<?php } ?>
<?php $blocks[71523]['object']->on_draw();?>
<?php $blocks[71525]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
