...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 6256,
      'name' => 'QuanLyLop',
      'path' => 'packages/sinhvien/modules/QuanLyLop/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 342,
  ...
  'name' => 'ds_lop',
  'title_1' => 'Danh sách lớp niên chế',
  'cachable' => 0,
  'params' => '',
  'hide' => 0,
  'theme' => 'web',
  'title' => 'Danh sách lớp niên chế',
);
...
<?php } ?>
<?php $blocks[77957]['object']->on_draw();?>
<?php $blocks[78649]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
