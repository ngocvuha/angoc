...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 6203,
      'name' => 'ManageHelper',
      'path' => 'packages/backend/modules/ManageHelper/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 332,
...
<?php } ?>
<?php $blocks[78694]['object']->on_draw();?>
<?php $blocks[78696]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
