			...
			<table cellpadding="10" cellspacing="0" border="1" width="100%" bordercolor="#e7e7e7">
				...
				<table cellpadding="10" cellspacing="0" border="1" width="100%" bordercolor="#e7e7e7">
					...
					<tr>
						...
						<td><input name="NgaySinh" type="text" id="NgaySinh" class="input-large date" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input name="MaSV" type="text" id="MaSV" class="input-large" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><select  name="tblLopNienChe_id" id="tblLopNienChe_id" class="input-large">{{String::get_select_list([[=tblLopNienChe=]],'tblLopNienChe_id',true)}}</select></td>
					</tr>
				</table>
			</td></tr></table>
