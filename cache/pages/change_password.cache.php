...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 6197,
      'name' => 'ChangePassword',
      'path' => 'packages/backend/modules/ChangePassword/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 332,
...
<?php } ?>
<?php $blocks[77560]['object']->on_draw();?>
<?php $blocks[77561]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
