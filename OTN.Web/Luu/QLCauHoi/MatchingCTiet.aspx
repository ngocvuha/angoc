<%@ page language="C#" masterpagefile="~/OTN.master" autoeventwireup="true" inherits="MatchingCTiet, App_Web_nvbb4npw" title="Untitled Page" %>
        ...
        <tr>
            <td with="100%" align="center">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td style="text-align: left; " colspan="4" class="HeaderTitles">Nhập lựa chọn và sự lựa chọn phù hợp  (A-1, B-2, vv). Các lựa chọn sẽ được đảo thứ tự khi hiện trên bài kiểm tra</td>
                    </tr>
                </table>
            </td>
        </tr>
                ...
                <table style="width: 100%">
                    <tr>
                        <td style="width: 47px">
                            <b>A.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswerA" runat="server" Height="170px"
                                Width="300px">
                        ...
                        <td>
                            <b>1.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswer1" runat="server" Height="170px"
                                Width="300px">
                                <StylesSpellChecker EnableDefaultAppearance="False">
                                </StylesSpellChecker>
                                <settingsimageupload>
                    ...
                    <tr>
                        <td style="width: 47px">
                            <b>B.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswerB" runat="server" Height="170px"
                                Width="300px">
                                <StylesSpellChecker EnableDefaultAppearance="False">
                                </StylesSpellChecker>
                                <settingsimageupload>
                        ...
                        <td>
                            <b>2.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswer2" runat="server" Height="170px"
                                Width="300px">
                                <StylesSpellChecker EnableDefaultAppearance="False">
                                </StylesSpellChecker>
                                <settingsimageupload>
                    ...
                    <tr>
                        <td style="width: 47px">
                            <b>C.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswerC" runat="server" Height="170px"
                                Width="300px">
                                <StylesSpellChecker EnableDefaultAppearance="False">
                                </StylesSpellChecker>
                                <settingsimageupload>
                        ...
                        <td>
                            <b>3.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswer3" runat="server" Height="170px"
                                Width="300px">
                                <StylesSpellChecker EnableDefaultAppearance="False">
                                </StylesSpellChecker>
                                <settingsimageupload>
                    ...
                    <tr>
                        <td style="width: 47px">
                            <b>D.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswerD" runat="server" Height="170px"
                                Width="300px">
                                <StylesSpellChecker EnableDefaultAppearance="False">
                                </StylesSpellChecker>
                                <settingsimageupload>
                        ...
                        <td>
                            <b>4.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswer4" runat="server" Height="170px"
                                Width="300px">
                                <StylesSpellChecker EnableDefaultAppearance="False">
                                </StylesSpellChecker>
                                <settingsimageupload>
                    ...
                    <tr>
                        <td style="width: 47px">
                            <b>E.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswerE" runat="server" Height="170px"
                                Width="300px">
                                <StylesSpellChecker EnableDefaultAppearance="False">
                                </StylesSpellChecker>
                                <settingsimageupload>
                        ...
                        <td>
                            <b>5.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswer5" runat="server" Height="170px"
                                Width="300px" AccessibilityCompliant="True">
                                <StylesSpellChecker EnableDefaultAppearance="False">
                                </StylesSpellChecker>
                                <settingsimageupload>
                                    <validationsettings allowedcontenttypes="image/jpeg,image/pjpeg,image/gif,image/png,image/x-png">
                    ...
                    <tr>
                        <td style="width: 47px">
                            <b>F.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswerF" runat="server" Height="170px"
                                Width="300px">
                                <StylesSpellChecker EnableDefaultAppearance="False">
                                </StylesSpellChecker>
                                <settingsimageupload>
                        ...
                        <td>
                            <b>6.</b></td>
                        <td>
                            <dxhe:ASPxHtmlEditor ID="htmlMatchingAnswer6" runat="server" Height="170px"
                                Width="300px">
                                <StylesSpellChecker EnableDefaultAppearance="False">
                                </StylesSpellChecker>
                                <settingsimageupload>
