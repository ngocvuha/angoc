<%@ page language="C#" masterpagefile="~/OTN.master" autoeventwireup="true" inherits="BangDiem, App_Web_zgkkpm8a" title="Untitled Page" enablesessionstate="True" trace="false" %>
    ...
    <dxwgv:ASPxGridView ID="gView" runat="server" 
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataTextColumn Caption="Họ và tên" FieldName="HoTen" 
                Name="HoTen" VisibleIndex="2" Width="170px">
                <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
            </dxwgv:GridViewDataTextColumn>
            ...
            <dxwgv:GridViewDataTextColumn Caption="Tên lớp" FieldName="TenLop" 
                Name="TenLop" VisibleIndex="5" Width="150px">
                <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="Điểm TN" FieldName="Diem" Name="Diem" 
                VisibleIndex="6" Width="70px">
                <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                <CellStyle HorizontalAlign="Right">
                </CellStyle>
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="Điểm viết" FieldName="DiemWriting" 
                Name="DiemWriting" VisibleIndex="7" Width="50px">
            ...
            <dxwgv:GridViewDataTextColumn Caption="Chi tiết bài viết" FieldName="Writing" 
                Name="Writing" VisibleIndex="8" Width="200px">
                <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="Tổng điểm" FieldName="TongDiem" 
                Name="TongDiem" VisibleIndex="9" Width="70px">
                <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                <CellStyle HorizontalAlign="Right" ForeColor=Red>
                </CellStyle>
            </dxwgv:GridViewDataTextColumn>
        </Columns>
    </dxwgv:ASPxGridView>
