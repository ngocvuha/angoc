...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 6290,
      'name' => 'EditCauHoi',
      'path' => 'packages/exam/modules/EditCauHoi/',
      'type' => NULL,
...
<?php } ?>
<?php $blocks[79722]['object']->on_draw();?>
<?php $blocks[79723]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
