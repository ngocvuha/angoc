	...
	<div class="form-content">
        ...
        <table width="100%" cellpadding="2" cellspacing="0" border="1" style="border-collapse:collapse" bordercolor="#CCCCCC">
            <tr class="ht">
                ...
                <td nowrap width="200" align="left"><a href="<?php echo String::order_by('tblphongthi.IDCauTrucDeThi');?>" class="orderby<?php echo String::order_by_active('tblphongthi.IDCauTrucDeThi');?>" title="<?php echo Portal::language('sort');?>">Môn thi</a></td>
