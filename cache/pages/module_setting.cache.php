...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 5894,
      'name' => 'ModuleSetting',
      'path' => 'packages/core/modules/ModuleSetting/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 2,
  ...
  'name' => 'module_setting',
  'title_1' => 'Quản lý Module Setting',
  'cachable' => 0,
  'params' => '',
  'hide' => 0,
  'theme' => 'web',
  'title' => 'Quản lý Module Setting',
);
...
<?php } ?>
<?php $blocks[77539]['object']->on_draw();?>
<?php $blocks[71433]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
