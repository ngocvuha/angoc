<div class="middle">
	...
	<div class="form-content">
        ...
        <table width="100%" cellpadding="6" cellspacing="0" border="1" style="border-collapse:collapse" bordercolor="#CCCCCC">
            ...
            <!--LIST:items-->
            <tr valign="middle" <?php Draw::hover('#E2F1DF');?> style="<.if($index++%2){echo 'background-color:#F9F9F9';}.>" id="DSPhongThi_tr_[[|items.id|]]">
                <td>
                    <label for="DSPhongThi_checkbox_[[|items.id|]]">[[|items.Ten|]]</label>
                </td>                
                ...
                <td align="center"><a href="{{Url::build_current(array('id'=>[[=items.id=]],'cmd'=>'view'))}}"><img width="16px" src="templates/admin/images/buttons/search.gif"></a></td>
            </tr>
            <!--/LIST:items-->
        </table>
