...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 6213,
      'name' => 'ZoneAdmin',
      'path' => 'packages/backend/modules/ZoneAdmin/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 332,
...
<?php } ?>
<?php $blocks[77988]['object']->on_draw();?>
<?php $blocks[77990]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
