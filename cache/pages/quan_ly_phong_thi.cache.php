...
$blocks = array (
  ...
  array (
    ...
    array (
      'id' => 6260,
      'name' => 'QuanLyPhongThi',
      'path' => 'packages/exam/modules/QuanLyPhongThi/',
      'type' => '',
      'action_module_id' => 0,
      'use_dblclick' => 0,
      'package_id' => 344,
  ...
  'name' => 'quan_ly_phong_thi',
  'title_1' => 'Quản Lý Phòng Thi',
  'cachable' => 0,
  'params' => '',
  'hide' => 0,
  'theme' => 'web',
...
<?php } ?>
<?php $blocks[78660]['object']->on_draw();?>
<?php $blocks[78661]['object']->on_draw();?><?php echo Portal::$extra_footer; echo Portal::get_setting('google_analytics');?>
</body>
</html>
