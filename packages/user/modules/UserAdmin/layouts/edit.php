        ...
        <form name="EditUserAdminForm" method="post">
            ...
            <table cellpadding="10" cellspacing="0" border="1" width="100%" bordercolor="#e7e7e7">
                <tr>
                    ...
                    <td><input name="account_id" type="text" id="account_id"{{Url::get('cmd')=='edit'?' disabled="disabled"':''}} class="input-large" /></td>
                </tr>
                <tr>
...
function create_account(block_id){
	...
	var check_account = check_ajax(block_id,{'cmd':'edit','id':'{{Url::nget("id")}}','action':'check_account','account':$('account_id').value});
	<!--ELSE-->
